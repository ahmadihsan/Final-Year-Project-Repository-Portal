<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlShowProjectListForReport.ascx.cs" Inherits="FYPAutomation.UserControls.General.CtrlShowProjectListForReport" %>
...
<div class="FieldSet">
    <fieldset class="FieldSet">
        ...
        <table style="width: 100%" class="mytable">
            <asp:GridView ID="GvdViewReports" runat="server" AutoGenerateColumns="False" ForeColor="#333333" GridLines="Both" Style="width: 100%; margin: 0 auto;" ShowHeaderWhenEmpty="True" CssClass="mytable" DataKeyNames="PId" EmptyDataText="No data found" OnSelectedIndexChanged="GvdViewReportsSelectedIndexChanged">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:CommandField SelectText="Detailed Report" ShowSelectButton="True" ItemStyle-Width="35%">
