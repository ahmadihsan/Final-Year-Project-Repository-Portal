namespace Sample.Web.UI.Compatibility {
    ...
    public class RegularExpressionValidator : System.Web.UI.WebControls.RegularExpressionValidator, IBaseValidatorAccessor {
        ...
        protected override void AddAttributesToRender(HtmlTextWriter writer) {
            ...
            if (RenderUplevel) {
                string id = ClientID;
                ValidatorHelper.AddExpandoAttribute(this, id, "evaluationfunction", "RegularExpressionValidatorEvaluateIsValid", false);
                if (ValidationExpression.Length > 0) {
                    ValidatorHelper.AddExpandoAttribute(this, id, "validationexpression", ValidationExpression);
                }
            }
        }
        ...
        protected override void RegisterValidatorDeclaration() {
            ...
            ValidatorHelper.DoValidatorArrayDeclaration(this, typeof(RegularExpressionValidator));
        }
