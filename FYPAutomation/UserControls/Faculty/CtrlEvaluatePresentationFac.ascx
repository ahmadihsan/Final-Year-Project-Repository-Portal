<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlEvaluatePresentationFac.ascx.cs" Inherits="FYPAutomation.UserControls.Faculty.CtrlEvaluatePresentationFac" %>
...
<div class="FieldSet">
    <fieldset class="FieldSet">
        ...
        <table class="mytable" style="width: 100%">
            <tr>
                <td>
                    <asp:DropDownList ID="ddlEvalType" Style="float:right" runat="server"></asp:DropDownList>
