<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlPCSecManager.ascx.cs" Inherits="FYPAutomation.UserControls.Convener.CtrlPCSecManager" %>
        ...
        <table style="width: 100%" class="mytable">
            <tr>
                <td>
                    ...
                    <div class="ButtonNavigations">
                        <label>
                            <asp:Button runat="server" ID="btnRemovePcMember" OnClick="DeletePcClick" CssClass="mybtn_remove" ToolTip="Add New" OnClientClick="return confirm('Do you want to delete PC Secretry?')"/>
                            <span>Delete</span>
                        </label>
                    </div>
