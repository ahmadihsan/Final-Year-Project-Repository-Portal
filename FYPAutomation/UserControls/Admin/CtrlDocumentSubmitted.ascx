        ...
        <table style="width: 100%" class="mytable">
            <tr>
                <td>
                    ...
                    <div class="ButtonNavigations">
                        <label>
                            <asp:Button runat="server" ID="btnfwdExt" OnClick="btnfwdExt_Click" CssClass="btn btn-primaryByMe" ToolTip="Forward to External" ValidationGroup="vgrExt" Text="Forward to External" />
                        </label>
                    </div>
                    
                     <div id="divExt" style="float: right">
                        <div class="ButtonNavigations">
                            <label>
                                <asp:DropDownList runat="server" ID="DropDownListExt"  DataTextField="Name" DataValueField="UId" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorExt" runat="server" ErrorMessage="Please Select External!" ControlToValidate="DropDownListExt" ForeColor="Red" InitialValue="Select External" ValidationGroup="vgr">Please Select External</asp:RequiredFieldValidator>
                            </label>
                        </div>
                    </div>
                    <br />
                    <br />
                    <div id="divv" style="float: right; margin-right:-230px">
                        <div class="ButtonNavigations">
                            <label>
                    ...
                    <asp:GridView ID="GvdViewAllDocs" runat="server" AutoGenerateColumns="False" ForeColor="#333333" Style="width: 100%; margin: 0 auto;" ShowHeaderWhenEmpty="True" CssClass="mytable"  EmptyDataText="No data found" GridLines="None" OnRowDataBound="GvdViewDocumentSumbittedRowDataBound" DataKeyNames="ProjectId,UMSId,UMSDId,FromPC,FromStudent,ReadStatus,InCustody" OnRowCommand="GvdViewAllDocsRowCommand">
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="Unassign">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkUnassign" CommandName="UnAssign" ForeColor="#8C4510" runat="server" CausesValidation="false" OnClientClick="return confirm('Do you want to un-assign this file?')">Un-assign</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                        </Columns>
                        ...
                        <td>
                            <asp:GridView ID="gvdViewHistory" runat="server" AutoGenerateColumns="False" ForeColor="#333333" Style="width: 100%; margin: 0 auto;" ShowHeaderWhenEmpty="True" CssClass="mytable" EmptyDataText="No data found" DataKeyNames="ProjectId,UMSId,FromPC,FromStudent,ReadStatus,InCustody">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="Supervisod By" />
                                    <asp:TemplateField HeaderText="In Custody" SortExpression="Status">
                                        <ItemTemplate>
