<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlDocsOfPc.ascx.cs" Inherits="FYPAutomation.UserControls.PCMember.CtrlDocsOfPc" %>
    ...
    <fieldset class="FieldSet">
        ...
        <div id="Search" style="float: right">
            <%--            <div class="ButtonNavigations">
                <label>
                    <asp:DropDownList runat="server" ID="ddlStudentSearchBySession"  DataTextField="Name" DataValueField="PSId" AutoPostBack="True" />
                </label>
            </div>--%>
            <div class="ButtonNavigations">
                <label>
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    <asp:GridView ID="GvdViewAllDocs" runat="server" AutoGenerateColumns="False" ForeColor="#333333" Style="width: 100%; margin: 0 auto;" ShowHeaderWhenEmpty="True" CssClass="mytable" PageSize="35" AllowPaging="True" EmptyDataText="No data found" GridLines="None" DataKeyNames="ProjectId,UMSId,FromPC,FromStudent,ReadStatus,InCustody,UMSDId,PMSId,Tiltle,MileStoneName" OnSelectedIndexChanged="GvdViewAllDocsSelectedIndexChanged">
                        <Columns>
...
<%--                            <asp:TemplateField HeaderText="Comment">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%#FYPDAL.FrequentAccesses.GetMsDocumentStatus(Convert.ToInt32(Eval("Status"))) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
            ...
            <fieldset class="FieldSet">
                ...
                <table class="mytable" style="width: 100%">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSumbitDoc" runat="server" Text="Submit Document" OnClientClick="return ConfirmMe()" OnClick="SubmitDocumentByPc" CssClass="btn btn-primaryByMe" ValidationGroup="vgRegisterFac" /></td>
                    </tr>
                </table>
            </fieldset>
        </div>
