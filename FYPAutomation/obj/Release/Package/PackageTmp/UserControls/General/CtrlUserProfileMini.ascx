<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlUserProfileMini.ascx.cs" Inherits="FYPAutomation.UserControls.CtrlUserProfileMini" %>
<div class="FieldSet">
    <fieldset class="FieldSet">
        <legend>User Profile</legend>

        <asp:FormView ID="FVFacProfile" runat="server" DataKeyNames="UId" Visible="False" RenderOuterTable="False">
            <ItemTemplate>
