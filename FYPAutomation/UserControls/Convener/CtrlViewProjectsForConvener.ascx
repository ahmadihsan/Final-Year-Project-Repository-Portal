<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlViewProjectsForConvener.ascx.cs" Inherits="FYPAutomation.UserControls.CtrlViewProjectsForConvener" %>
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            <td>Proposed By :
                                ...
                                <asp:LinkButton runat="server" Text="Delete" OnClientClick="return confirm('Do you want to delete this Project?')" ID="lnkCancel" Visible='<%#FYPUtilities.FYPSession.GetLoggedUser().RoleName.ToLower()=="convener"%>' OnClick="CancelClick" CommandArgument='<%#Eval("PId") %>' Style="float:right"></asp:LinkButton>
                            </td>
