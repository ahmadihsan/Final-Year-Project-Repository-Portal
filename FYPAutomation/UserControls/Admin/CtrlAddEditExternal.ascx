<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAddEditExternal.ascx.cs" Inherits="FYPAutomation.UserControls.Admin.CtrlAddEditExternal" %>
    ...
    <table style="width: 99%">
        <tr>
            ...
            <td class="TextAlignRight">
                <asp:Button ID="btnRegisterExternal" CssClass="btn btn-primaryByMe" runat="server" Text="Register" Width="100px" OnClick="AddExternal" />
            </td>
        </tr>
