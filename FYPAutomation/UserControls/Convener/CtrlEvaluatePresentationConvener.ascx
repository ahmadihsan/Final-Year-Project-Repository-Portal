<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlEvaluatePresentationConvener.ascx.cs" Inherits="FYPAutomation.UserControls.Convener.CtrlEvaluatePresentationConvener" %>
    ...
    <fieldset class="FieldSet">
        ...
        <asp:GridView ID="GvdViewAllDocs" runat="server" AutoGenerateColumns="False" ForeColor="#333333" Style="width: 100%; margin: 0 auto;" ShowHeaderWhenEmpty="True" CssClass="mytable" EmptyDataText="No data found" GridLines="None" PageSize="35" AllowPaging="True" DataKeyNames="ProjectId,UMSId,FromPC,FromStudent,InCustody,UMSDId,PMSId,Tiltle,MileStoneName,EvalStatus" OnRowDataBound="GvdViewAllDocs_RowDataBound" OnSelectedIndexChanged="GvdViewAllDocs_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="MileStoneName" HeaderText="MileStone" SortExpression="MileStoneName" />
                ...
                <asp:TemplateField HeaderText="Download File">
                    <ItemTemplate>
                        <asp:HyperLink ID="LinkButton1" runat="server" NavigateUrl='<%# string.Format("{0}{1}",ConfigurationManager.AppSettings["AllUploadsUrl"],Eval("UploadedFile"))%>' Text="Download"> 
                            <%--Enabled='<%#!FYPDAL.FrequentAccesses.GetBooleanFrom10(Convert.ToInt32(Eval("EvalStatus")))%>'--%>
                        </asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
