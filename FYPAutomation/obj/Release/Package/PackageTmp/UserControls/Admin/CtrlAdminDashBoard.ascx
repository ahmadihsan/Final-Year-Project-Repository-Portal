...
<%@ Register Src="~/UserControls/Admin/CtrlAdminNotificationSideBar.ascx" TagPrefix="uc1" TagName="CtrlAdminNotificationSideBar" %>
...
<div style="width:50%; float: left">
    ...
    <div class="DashIcon"><a href='<%=VirtualPathUtility.ToAbsolute("~/Pages/Admin/MileStoneDeadline.aspx") %>'><img src="../../Images/DashBoardImages/announcment.png" /><span style="margin-top: -14px">Milestone Deadline</span>s</a></div>
...
<%--This is just Dummy Text for future Use--%>
    <uc1:CtrlAdminNotificationSideBar runat="server" id="CtrlAdminNotificationSideBar" />
</div>