namespace Sample.Web.UI.Compatibility {
    ...
    public class RequiredFieldValidator : System.Web.UI.WebControls.RequiredFieldValidator, IBaseValidatorAccessor {
        ...
        protected override void AddAttributesToRender(HtmlTextWriter writer) {
            ...
            if (RenderUplevel) {
                string id = ClientID;
                ValidatorHelper.AddExpandoAttribute(this, id, "evaluationfunction", "RequiredFieldValidatorEvaluateIsValid", false);
                ValidatorHelper.AddExpandoAttribute(this, id, "initialvalue", InitialValue);
            }
        }
        ...
        protected override void RegisterValidatorDeclaration() {
            ...
            ValidatorHelper.DoValidatorArrayDeclaration(this, typeof(RequiredFieldValidator));
        }
