        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlSession" ErrorMessage="Please select depratment" ForeColor="Red" InitialValue="Select Session" ValidationGroup="vgRegister">Please select Session</asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
