<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlProjectArchive.ascx.cs" Inherits="FYPAutomation.UserControls.Admin.CtrlProjectArchive" %>

<div class="FieldSet">
    <fieldset class="FieldSet">
        <legend>Submitted Archives:</legend>
