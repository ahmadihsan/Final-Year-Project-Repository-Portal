            ...
            <ItemTemplate>
                ...
                <tr>
                    <td>
                        ...
                        <asp:HyperLink runat="server" Text="More Detail" ID="lnkMoreDetail" NavigateUrl='<%# string.Format("~/Pages/Admin/ProjectDetail?PId={0}",Eval("PId"))%>' Visible="True"></asp:HyperLink>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Proposed By :
                        ...
                        <asp:LinkButton runat="server" Text="Delete" ID="lnkCancel" OnClientClick="return confirm('Do you want to delete this Project?')" Visible='<%#FYPUtilities.FYPSession.GetLoggedUser().RoleName.ToLower()=="admin"?true:false%>' OnClick="CancelClick" CommandArgument='<%#Eval("PId") %>' Style="float: right"></asp:LinkButton>
                    </td>
