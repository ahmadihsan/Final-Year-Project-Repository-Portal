<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlMyRemarksFac.ascx.cs" Inherits="FYPAutomation.UserControls.Faculty.CtrlMyRemarksFac" %>
                    ...
                    <asp:ListView ID="lstComments" runat="server" ItemPlaceholderID="plItems">
                        ...
                        <ItemTemplate>
                            <th>
                                ...
                                <asp:HyperLink ID="hplUpdate" runat="server" Text="Update Remarks" NavigateUrl='<%#"~/Pages/Convener/UpdateDocEvalCon.aspx?project=" + Eval("Tiltle") + "&Doc="+ Eval("projectMileName")%>' CssClass="alignRight" />
                            </th>
                            <tr>
                            ...
                            <tr>
                                <td style="font-weight: bold">Comments By <asp:Label ID="lblCommentBy" runat="server" Text= '<%# Bind("RoleName") %>'></asp:Label>:  <asp:Label runat="server" Text='<%# Bind("Name") %>' ID="lblSN" Style="color:blue"></asp:Label><br />
                                    ...
                                    <asp:Label ID="lblCommentsExt" runat="server" Text='<%# Bind("CommentedByPCHead") %>' Style="color: #005580; font-weight: normal" ></asp:Label>
