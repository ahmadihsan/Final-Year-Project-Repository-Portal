<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAddPcSec.ascx.cs" Inherits="FYPAutomation.UserControls.Convener.CtrlAddPcSec" %>

<div class="FieldSet">
    <fieldset class="FieldSet">
        <legend>Add PC secretary : </legend>
