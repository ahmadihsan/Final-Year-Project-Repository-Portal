<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlProjectDetailFacPC.ascx.cs" Inherits="FYPAutomation.UserControls.General.CtrlProjectDetailFacPC" %>
...
<div class="FieldSet">
    <fieldset class="FieldSet">
        ...
        <asp:FormView ID="FVProjectDetail" runat="server" OnModeChanging="FVProjectDetail_ModeChanging" OnItemUpdating="FVProjectDetail_ItemUpdating" DefaultMode="ReadOnly" OnDataBound="FVProjectDetail_DataBound" Width="100%">
            <ItemTemplate>
                <table style="width: 100%" class="mytable">
                    ...
                    <tr>
                        <td>Status:</td>
                        <td>
                            <asp:Label ID="StatusLabel" runat="server" Text='<%#FYPDAL.FrequentAccesses.GetStatusByValue(Convert.ToInt16(Eval("Status"))) %>' />
                    ...
                    <tr>
                        <td style="border-right: none">
                            <asp:LinkButton runat="server" ID="lnkAssign" CausesValidation="False" CssClass="left" Text="Assign/UnAssign This Project To Student" OnClick="lnkAssign_Click"></asp:LinkButton>
                        </td>
