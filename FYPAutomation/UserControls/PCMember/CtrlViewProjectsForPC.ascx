<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlViewProjectsForPC.ascx.cs" Inherits="FYPAutomation.UserControls.CtrlViewProjectsForPC" %>
    ...
    <fieldset class="FieldSet">
       ...
       <asp:ListView ID="lstProjects" runat="server" ItemPlaceholderID="plItems" OnPagePropertiesChanging="LstProjectsPagePropertiesChanging" >
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            <td>Proposed By :
                                 <asp:HyperLink runat="server" Text='<%# Bind("Name") %>' ID="lnkProposedBy" NavigateUrl='<%# string.Format("~/Pages/PCMember/UserMiniProfile.aspx?UId={0}",Eval("ProposedBy"))%>'></asp:HyperLink>   
