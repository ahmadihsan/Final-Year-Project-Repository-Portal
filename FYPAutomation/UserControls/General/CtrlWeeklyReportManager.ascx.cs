...
{
    public partial class CtrlWeeklyReportManager : FYPBaseUserControl
    {
        ...
        protected void GvdViewReportsSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Pages/Convener/WeeklyReportDetail.aspx?pId=" + pId);
            }
            if (FYPUtilities.FYPSession.GetLoggedUser().RoleName.ToLower() == "admin")
            {
                Response.Redirect("~/Pages/Admin/WeeklyReportDetail.aspx?pId=" + pId);
            }
