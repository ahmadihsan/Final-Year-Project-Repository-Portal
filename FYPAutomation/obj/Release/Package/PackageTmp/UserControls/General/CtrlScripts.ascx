...
<ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    <Scripts>
        ...
        <asp:ScriptReference Path="~/Scripts/my.js"></asp:ScriptReference>
        <asp:ScriptReference Path="~/Scripts/jquery.timepicker.js"></asp:ScriptReference>
        <asp:ScriptReference Path="~/Scripts/Time.js"></asp:ScriptReference>
    </Scripts>
