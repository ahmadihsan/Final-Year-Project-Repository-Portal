    ...
    <Items>
        <asp:MenuItem Text="User Manager" Value="Admin">
            ...
            <asp:MenuItem Text="External Manager" Value="Admin">
                <asp:MenuItem NavigateUrl="~/Pages/Admin/AddExternal.aspx" Text="Add External" Value="Add External"></asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/Pages/Admin/BulkAddExternal.aspx" Text="Add External (Bulk)" Value="Add External (Bulk)"></asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/Pages/Admin/ViewExternal.aspx" Text="View External" Value="View External"></asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/Pages/Admin/ExternalManager.aspx" Text="Create Group" Value="Manage External"></asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/Pages/Admin/ViewExternalGroups.aspx" Text="View Groups" Value="Manage External"></asp:MenuItem>
