<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlAddProject.ascx.cs" Inherits="FYPAutomation.UserControls.CtrlAddProject" %>
...
<div class="FieldSet">
    <fieldset class="FieldSet">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td class="TitleTd"><h6><b>Select Session:</b></h6></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlProposedBy" runat="server" DataTextField="Name" DataValueField="UId">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlProposedBy" ErrorMessage="Faculty required" ForeColor="Red" InitialValue="Select Faculty">Please Select Faculty</asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEffortsRequired" runat="server" TextMode="MultiLine" Width="500px" Height="150px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <ajaxToolkit:AjaxFileUpload ID="AfuProjectDoc" runat="server" AllowedFileTypes="docx,doc,pdf" ContextKeys="fred" MaximumNumberOfFiles="1"  OnUploadComplete="AfuProjectDocUploadComplete" ThrobberID="myThrobber" />(optional)
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td class="TitleTd">&nbsp;</td>
                <td>
                    <asp:Button ID="btnAddProject" CssClass="btn btn-primaryByMe" runat="server" Width="100px" runat="server" OnClick="BtnAddProjectClick" Text="Add Project" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
