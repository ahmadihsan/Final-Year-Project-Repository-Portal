    ...
    <fieldset class="FieldSet">
        ...
        <table style="width: 100%" class="mytable">
            ...
            <tr>
                ...
                <td>
                    <ajaxToolkit:AjaxFileUpload ID="AfuProjectDoc" runat="server" AllowedFileTypes="docx,doc,pdf,xlsx,xls,ppt,pptx" ContextKeys="fred" MaximumNumberOfFiles="1"  OnUploadComplete="AfuProjectDocUploadComplete" ThrobberID="myThrobber" />(optional)<br/>
